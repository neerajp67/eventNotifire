...
import eventnotifier.en.en.utils.main.editProfile.createProfile.CreateProfileActivity;
import eventnotifier.en.en.utils.utils.GoogleApiHelper;
...
public class LoginActivity extends BaseActivity<LoginView, LoginPresenter> implements LoginView, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void signInWithFacebook() {
        Toast.makeText(LoginActivity.this,"Feature Not available..",Toast.LENGTH_SHORT).show();
